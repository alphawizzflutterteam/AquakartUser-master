...
extension colors on ColorScheme {
  ...
  static const Color primary = Color(0xff15406d);
  static const Color secondary = Color(0xffa2d5e6);
  ...
  static const Color grad1Color = Color(0xff15406d);
  static const Color grad2Color = Color(0xffa2d5e6);
